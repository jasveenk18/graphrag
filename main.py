...
def main():
    ...
    if 'OPENAI_API_KEY' not in st.session_state:
        ...
        if openai_api_key:
            ...
            if 'embeddings' not in st.session_state or 'llm' not in st.session_state:
...
# Initialize variables
    neo4j_url = "neo4j+s://513a2397.databases.neo4j.io"	
    neo4j_username = "neo4j"
    neo4j_password = "i8s6xa2n7d19ck8YR6dWbhlEJCKeG0Ttsm2ADZnmagw"
    graph = None	
